...
chatui.onLoad = function(){
  ...
  var recoverBtn =  '<div class="recover" id="chatbot-recover">'
    +    '<img src="https://storage.googleapis.com/singlex-ai-chatbot-contents/1bfbf1e1-b595-42a8-8ed8-256bcedd562e/images/gpt_resize3.png"/>'
    +'</div>';
  
  var winopenBtn = '<div class="winopen" id="chatbot-winopen">'
    +    '<img src="https://storage.googleapis.com/singlex-ai-chatbot-contents/1bfbf1e1-b595-42a8-8ed8-256bcedd562e/images/gpt_winopen3.png"/>'
    +'</div>';
  ...
  $(".test-panel .panel-wrapper .chat-panel .info-area").html(
    ...
    +    '<img src="https://storage.googleapis.com/singlex-ai-chatbot-contents/1bfbf1e1-b595-42a8-8ed8-256bcedd562e/images/img_close.png" />'
    +'</div>'
  );
